...
const { createOrganizer, getAllOrganizers, getOrganizerById, updateOrganizer,updateOrganizerPhoto, deleteOrganizer } = require("../organizer/controller/organizer.controller");
